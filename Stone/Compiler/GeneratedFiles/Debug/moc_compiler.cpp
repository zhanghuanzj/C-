...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Compiler_t, stringdata) + ofs \
...
const QMetaObject Compiler::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Compiler.data,
      qt_meta_data_Compiler,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Compiler.stringdata))
